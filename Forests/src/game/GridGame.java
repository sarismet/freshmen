 ...
 *
 * IMPORTANT: Please do not modify this class in any way, it will be reset when
...
public abstract class GridGame {
	 ...
	 * @param frameRate
	 *            frame rate denoting the number of ticks per second
	 */
	...
	/**
	 * Adds a new drawable object to the game. The added object will be drawn on the
	 * panel at each tick via its draw(...) method.
	 * 
	 * @param drawable
	 */
	...
	/**
	 * Starts the game loop. The game loop periodically calls method timerTick(), at
	 * the set frame rate.
	 */
	public void start() {
	...
	/**
	 * Periodically executed timer tick method. Every subclass should implement this
	 * method to define its game logic.
	 */
